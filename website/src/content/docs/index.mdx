---
title: "QKrylov: The Polyglot Quantum Engine"
description: "High-performance, matrix-free exact diagonalization engine for Python, Julia, and C++"
template: splash
hero:
  tagline: High-performance, matrix-free exact diagonalization engine for Python, Julia, and C++.
  actions:
    - text: Quickstart
      link: /qkrylov/quickstart/
      icon: right-arrow
      variant: primary
    - text: GitHub Repository
      link: https://github.com/sjp95/qkrylov
      icon: external
      variant: minimal
---
