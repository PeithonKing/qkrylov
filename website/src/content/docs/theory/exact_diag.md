...
description: "Exponential scaling of Hilbert spaces, quantum symmetry reduction, and the matrix-free paradigm"
---
...
- The operator expression is represented as an [`OpSum`](/qkrylov/api/python/).
