---
title: "QKrylov Master Scaling Benchmark"
description: "Interactive performance benchmarks comparing CPU vs GPU execution times across single-pass and two-pass Lanczos"
---

<script is:inline src="https://cdn.plot.ly/plotly-2.27.0.min.js"></script>
<style>
:root {
  --md-code-bg-color: var(--sl-color-bg-inline-code, #1e1e2e);
  --md-default-fg-color: var(--sl-color-text, #cdd6f4);
  --md-default-fg-color--light: var(--sl-color-gray-3, #6c7086);
  --md-default-fg-color--lighter: var(--sl-color-gray-5, #45475a);
  --md-default-bg-color: var(--sl-color-bg, #181825);
  --md-primary-fg-color: var(--sl-color-accent-high, #89b4fa);
}
