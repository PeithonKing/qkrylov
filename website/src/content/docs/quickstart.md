---
title: "Quickstart: Heisenberg Model in 5 Minutes"
description: "Step-by-step guide to solving the quantum Heisenberg model using qkrylov across Python, Julia, and C++"
---
...
See [SciML Integration](/qkrylov/getting_started/sciml_julia/) for how to use `solve(prob, Lanczos())`.
:::
:::
::::
